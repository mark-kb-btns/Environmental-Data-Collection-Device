/*
  A stationary environmental data collection device designed for Arduino UNO
  by: Mark Alatraca
*/
...
//////////////////////////////// INITIALIZATION ////////////////////////////////
//initiale Grove Light Sensor
const int LIGHT_SENSOR_PIN = A0;
LightSensor lightSensor(LIGHT_SENSOR_PIN); //refer to the h file

//initiale DHT11 Sensor
/*const int HNT_SENSOR_PIN = A1;
DHT11 hnt(HNT_SENSOR_PIN);*/ //refer to the h file

//initialize Sharp Optical Dust Sensor GP2Y1010AU0F
const int DUST_SENSOR_MEASUREPIN = A2;
const int DUST_SENSOR_LEDPIN = 7;
SHARP dust(DUST_SENSOR_MEASUREPIN, DUST_SENSOR_LEDPIN); //refer to the h file

const int chipSelect = 10;

//initialize RTC module DS1302
ThreeWire myWire(4, 5, 2); // Data, CLK, RST
RtcDS1302<ThreeWire> rtc(myWire); //RtcDS1302.h
